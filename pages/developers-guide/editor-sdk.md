...
MapLinkEDT64.lib Release mode, DLL version. Uses Multithreaded DLL C++ run-time library. Requires TTLDLL preprocessor directive. Refer to the document "MapLink Pro: Deployment of End User Applications" for a list of run-time dependencies when redistributing. |
