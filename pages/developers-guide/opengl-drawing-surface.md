...
+---------------------------------+------------------------------------+
| **MapLinkOpenGLSurface64.lib**  | **MapLinkOpenGLSurface64d.lib**    |
|                                 |                                    |
...
| CoreSDK library MapLink64.lib   | library MapLink64d.lib             |
|                                 |                                    |
...
+--------------+---------------------------+-----------------------------+
| OpenGL       | Required Extensions       | Recommended Extensions      |
| Version      |                           |                             |
+==============+===========================+=============================+
