...
| Direct Import | Supported | 11.1.2 | 11.1.2 | 10.2 | Yes | Yes | Yes |
| Dynamic Data Objects (DDO) | **Deprecated** Superseded by Tracks | 11.1.2 | 11.1.2 | | Yes | Yes | |
...
| KML 2D Layer | Supported | 11.1.2 | | | Yes | | |
| MapLink OWS | Supported | 11.1.2 | | | Yes | | |
| Network | Supported | 11.1.2 | | | Yes | | |
| OGC Filter SDK | **Archived** | | | | | | |
| OGC Framework | Supported | 10.2 | 10.2 | 10.2 | Yes | Yes | Yes |
| OpenGL Drawing Surface | Supported | 11.1.2 | 11.1.2 | | Yes | Yes | |
...
| Terrain | Supported | 11.1.2 | 11.1.2 | 10.2 | Yes | Yes | Yes |
| Terrain Viewshed | Supported | 11.1.2 | 11.1.2 | 10.2 | Yes | Yes | Yes |
| Terrain Contouring | **Deprecated** Use gdal_contour | | | | Yes | | |
| Time | **Deprecated** | 10.2 | | | Yes | | |
| Tracks | Supported | 11.1.2 | 11.1.2 | 10.2 | Yes | Yes | Yes |
| WMTS Data Layer | Supported | 11.1.2 | 11.1.2 | 10.2 | Yes | | |
...
| GL Data Optimiser | Supported | 11.1.2 | 11.1.2 | |
| Imagery Masking Tool | Supported | 10.2 | | |
| Image Studio | Supported | 11.1.2 | | |
| **MapLink Studio** | Supported | 11.1.2* | | |
| MapLink Studio Automation | Supported | 11.1.2 | | |
| MapViewer | Supported | 11.1.2 | | |
| Print Template Studio | Supported | 10.2 | | |
| Raster Compressor | Supported | | | 10.2 |
| Rendition Editor | Supported | 10.2 | | |
| Symbol Studio | Supported | 11.1.2 | | |
...
| -- | -- | -- |
| ADRG | Supported | 11.1.2 |
| ArcGrid | Supported | 11.1.2 |
| ARCS | Supported | 11.1.2 - On request |
| Envtia ASCII | **Deprecated** | 10.2 |
| ASCII DEM | Supported | 11.1.2 |
| ASRP | Supported | 11.1.2 |
| OS Boundary Line | **Deprecated** | 10.2 |
| CADRG | Supported | 11.1.2 |
| CIB | Supported | 11.1.2 |
| CRP | **Deprecated** | 10.2 |
| DAFIF | Supported | 11.1.2 |
| DBDBV | Supported | 11.1.2 |
| DFAD | **Deprecated** | 10.2 |
| DTM/DTED | Supported | 11.1.2 |
| DXF | Supported | 11.1.2 |
| File GeoDatabase | Supported | 11.1.2 |
| GDAL | Supported | 11.1.2 |
| GeoPackage | Supported | 11.1.2 |
| GeoTIFF | Supported | 11.1.2 |
| GDF | Supported | 11.1.2 |
| GML | Supported | 11.1.2 |
| Jeppesen (ARINC) | Supported | 11.1.2 |
| JPEG2000/GMLJP2 | Supported | 11.1.2 |
| KML | Supported | 11.1.2 |
| MIF (MapInfo) | **Deprecated** | 10.2 |
| NITF | Supported | 11.1.2 |
| NTF | Supported | 11.1.2 |
| OGR | Supported | 11.1.2 |
| OS Master Map | Supported | 11.1.2 |
| Raster (generic) | Supported | 11.1.2 |
| S-57 | Supported | 11.1.2 |
| Shapefile | Supported | 11.1.2 |
| VPF | Supported | 11.1.2 |
